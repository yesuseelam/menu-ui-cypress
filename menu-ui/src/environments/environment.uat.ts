...
export const environment: Environment = {
    production: true,
    showDevModule: false,
    _API_URL_V2 : "https://menu-api.restsolutions-uat.cfadevelop.com",

    _OKTA_DETAILS : {
        appName: 'Chick-fil-A',
        uiRedirectUrl: 'https://menu.restsolutions-uat.cfadevelop.com',// for local testing use 'http://localhost:4200',
